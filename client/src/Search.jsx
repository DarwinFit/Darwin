	...
	render() {
		...
		return (
			<div className="SearchBar">
				...
				<input type="text" value={value} onChange={this.handleOnChange.bind(this)} placeholder={placeholder} />
				<button className="" type="submit" onSubmit={this.handleSubmit.bind(this)}>
					Look it Up!
				</button>
			</div>
		);
